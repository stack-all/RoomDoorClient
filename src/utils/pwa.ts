...
export function showInstallPrompt() {
  ...
  function showCustomInstallButton() {
    ...
    installButton.className = 'fixed bottom-4 right-4 bg-primary-500 text-white px-4 py-2 rounded-lg shadow-lg z-50'
...
function showOfflineNotification() {
  ...
  notification.className = 'fixed top-4 left-1/2 transform -translate-x-1/2 bg-yellow-500 text-white px-4 py-2 rounded-lg shadow-lg z-50'
